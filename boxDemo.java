...
public class boxDemo {
     ...
     * Box b1 = new Box();
     * Box b2 = b1;
     * here b2 is assigned to b1 object, but no separate space is allocated to b2.
     * b2 is a reference to the same memory location as of b1.
     */
     ...
     * constructor’s job to initialize the internal state of an object so that the
